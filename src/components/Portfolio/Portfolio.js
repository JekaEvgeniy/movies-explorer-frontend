    ...
    <section className="portfolio">
      ...
      <ul className="portfolio-items">
        <li className="portfolio-items__item">
          <a href="https://jekaevgeniy.github.io/russian-travel/index.html" className="portfolio__link" target="_blank">
        ...
        <li className="portfolio-items__item">
          <a href="https://jekaevgeniy.github.io/mesto/index.html" className="portfolio__link" target="_blank">
